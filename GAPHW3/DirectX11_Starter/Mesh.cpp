...
Mesh::Mesh(char* f, ID3D11Device* devObj){
	// File input object
	std::ifstream obj(f); // <-- Replace filename with your parameter
...
Mesh::~Mesh()
{
	...
	if(indexBuffer) ReleaseMacro(indexBuffer);
